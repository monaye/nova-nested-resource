<router-link tag="h3" :to="{name: 'categories'}" class="cursor-pointer flex items-center font-normal dim text-white mb-6 text-base no-underline">
    @if(method_exists('\App\Nova\Category', 'icon'))
       {!! \App\Nova\Category::icon() !!}
    @else
